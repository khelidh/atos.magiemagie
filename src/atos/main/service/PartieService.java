...
public class PartieService {
    ...
    public static final Long POSITION_DE_DEPART = 1L;
    ...
    /////////////////////
    public void creer(String pseudo, String avatar) {
    ...
    public void demarrer(Long idPartie){  
        ...
        if ((partieDAO.findNombreJoueurEnAttente(idPartie) > 1) && (partie.getEtat() == EtatPartie.EN_PREPARATION)){
            ...
            joueurs.get(0).setEtat(EtatJoueur.A_LA_MAIN);
    ...
    ///////////////////// 
    /**
     * A partir du dealer actuel, cherche le prochaine joueur toujours en jeu. S'il est en sommeil, 
     * on modifie son état et on cherche le prochain joueur jusqu'à trouver un joueur 
     * avec un etatJoueur = PAS_LA_MAIN
     * @param Long
     * @return Joueur
     */
    ...
    public void distribuer(Long idPartie){
        for (Joueur joueur : getAllJoueurs(idPartie))
